...
requireMatch(html.includes('operationLastClearDay') && html.includes("if(won)meta.operationLastClearDay=localDayKey()"), 'Build 171 daily reward protection is missing');
