// Build 144 — production 2.5D sprite integration.
(function () {
  'use strict';
  if (window.__LSC_COMMAND_BASE_144__) return;
  window.__LSC_COMMAND_BASE_144__ = true;
  ...
  function drawProductionBoss(e){var s=dpr();if(!spriteCell(7,e.x,e.y+43*s,122*s,116*s))drawBoss(e);}
