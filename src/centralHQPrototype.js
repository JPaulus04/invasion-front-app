...
(function () {
  ...
  function enemy(kind) {
    ...
    var slotId=run.spawned++,slots=24,slotIndex=slotId%slots,slotLayer=Math.floor(slotId/slots)%3,slotAngle=(slotIndex/slots)*TAU,slotRadius=(kind==='boss'?112:86+slotLayer*13)*s;
