// Build 138 — two-resource Command Base economy and rebuilt radial combat presentation.
(function () {
  'use strict';
  if (window.__LSC_COMMAND_BASE_138__) return;
  window.__LSC_COMMAND_BASE_138__ = true;
