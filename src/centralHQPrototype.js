// Build 185 — campaign atmosphere and decisive combat-impact presentation.
(function () {
  'use strict';
  ...
  function useAbility(){
    ...
    run.enemies.forEach(function(e){var dealt=Math.min(run.abilityDamage,e.hp);e.hp-=run.abilityDamage;run.damage.artillery+=dealt;});
