// Build 180 — unified compact Research doctrine board.
(function () {
  'use strict';
  ...
  var QA_TEST_ACCESS = typeof LSC_BUILD !== 'undefined' && String(LSC_BUILD) === '180';
  ...
  function energyRechargeCopy(){
    if(QA_TEST_ACCESS)return'BUILD 180 QA ACCESS';
    availableEnergy();
  ...
  function renderOperationsTab(panel){
    ...
    var qaBanner=QA_TEST_ACCESS?'<div class="l175-qa-banner"><b>BUILD 180 · QA TEST ACCESS</b>OPERATIONS REMAIN REPEATABLE FOR TESTING · ONLY THE FIRST CLEAR OF THE DAY AWARDS RESOURCES</div>':'';
  ...
  function renderTab(tab,options) {
    ...
    if (tab === 'campaign') {
      ...
      var qaBanner=QA_TEST_ACCESS?'<div class="l175-qa-banner"><b>BUILD 180 · QA TEST ACCESS</b>UNLIMITED CAMPAIGN ENERGY · REPEATABLE OPERATIONS · DAILY RESOURCES STILL AWARD ONLY ONCE</div>':'';
