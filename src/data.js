...
const REWARD_POOL = [
  ...
  { id:'r_reinforce',  tier:2, docSynergy:['logistics'],       docExclusive:null,        name:'Forward Deployment',       text:'Free Rifle Squad to every lane.',                        apply:(s,G)=>{const cap=G.troopSlots(s.prestige);[0,1,2].forEach(l=>{if(G.laneTroopCount(l)<cap)s.troops.push(G.createTroop('rifle',l));});} },
  // Tier 3 — rare
